...
def process_dict(df):
    ...
    processed_docs =  df['Post'].map(preprocess)
...
def Topic_CombinedWord_ProbTopic(topic_combined_top_words, topic_prob, source, num_topics):
...
def lda(dict_tfidf_filtered, bow_corpus_TFIDFfiltered,
    ...
    for num_topics in range(start, limit, step):
        ...
        #save_model_path = save_model_dir + source + '_' + str(num_topics) + '_topics/'
        ...
        result = Topic_CombinedWord_ProbTopic(topic_combined_top_words, topic_prob, source, num_topics)
    ...
    #num_topics_performance.to_csv(save_performance_dir + source + '_' + '.csv', index=False)
